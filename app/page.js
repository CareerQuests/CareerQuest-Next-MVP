    ...
    <div className="max-w-7xl mx-auto px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Our innovative platform combines AI technology with real-world
          insights
        </p>
      </div>
        ...
        {[
          {
            ...
            description:
              "Advanced algorithms analyze your skills, interests, and personality to find perfect career matches",
          ...
          },
          {
            ...
            description:
              "Access current market data, salary trends, and growth opportunities in various fields",
          ...
          },
          {
            ...
            description:
              "Get customized learning paths and development plans based on your career goals",
          ...
          >
            <div
              className={`absolute bottom-0 right-0 w-32 h-32 ${item.glow} blur-[64px] opacity-60 group-hover:opacity-100 transition-opacity`}
            />
            <div className="relative z-10">
              <div
                className={`flex justify-center items-center w-12 h-12 rounded-xl ${item.glow} mb-6 ${item.color}`}
              >
                {item.icon}
              </div>
  ...
  <div className="py-24 relative">
    ...
    <div className="max-w-7xl mx-auto px-8 relative">
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Discover opportunities across various industries with real-time
          insights
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {careerFields.map((field, index) => (
          <div
            key={index}
            className={`relative bg-gray-800/30 backdrop-blur-sm p-8 rounded-2xl border ${field.borderColor} overflow-hidden group hover:border-opacity-50 transition-all`}
          >
            <div
              className={`absolute bottom-0 right-0 w-32 h-32 ${field.glowColor} blur-[64px] opacity-60 group-hover:opacity-100 transition-opacity`}
            />
            <div className="relative z-10">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {field.skills.map((skill, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 bg-gray-700/30 rounded-full text-sm text-gray-400 group-hover:text-gray-300 transition-colors"
                      >
                        {skill}
                      </span>
                    ))}
        ...
        <Link href="/about" className="group">
          <div className="relative bg-gray-800/30 backdrop-blur-sm p-8 rounded-2xl border border-blue-500/20 overflow-hidden group-hover:border-blue-500/40 transition-all h-full">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">
                Discover how our AI technology matches you with the perfect
                career
              </p>
    ...
    <div className="min-h-screen bg-transparent text-gray-100">
      ...
      <div className="pt-32 px-8 max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-400 text-xl mb-12 max-w-2xl mx-auto">
          Join thousands of professionals finding their ideal career through
          personalized assessments and data-driven insights
        </p>
